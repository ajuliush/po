            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    {{ request()->is('debtors') ? 'menu-open' : '' }}
                        ...
                        <ul class="treeview-menu" style=" {{ request()->is('creditors') || request()->is('debtors') ? 'display: block;' : 'display: none;' }}">
                            <li><a href="/creditors"><i class="fa fa-circle-o"></i> Creditors</a></li>
                            <li><a href="/debtors"><i class="fa fa-circle-o"></i> Debtors</a></li>
                        </ul>
                    </li>
                    <li class="treeview  {{ request()->is('locations') ? 'menu-open' : '' }}
                        ...
                        <ul class="treeview-menu" style=" {{ request()->is('locations') || request()->is('cities') || request()->is('provinces') || request()->is('countries') ? 'display: block;' : 'display: none;' }}">
                    ...
                    ">
                        ...
                        <ul class="treeview-menu" style=" {{ request()->is('locations') 
                        || request()->is('item-categories') 
                        || request()->is('item-groups') 
                        || request()->is('item-units')
                        || request()->is('currencies')
                        || request()->is('items') ? 'display: block;' : 'display: none;' }}">
